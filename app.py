...
# ==========================================
st.set_page_config(
    page_title="2026 復興區花季行程規劃 (iOS修復版)",
    page_icon="🌸",
    layout="centered",
...
all_spots_db = [
    # --- 您的 6 大指定重點名所 (置頂) ---
    {"name": "翠墨山莊 (翠墨庄園)", "region": "前山", "month": [1, 2], "type": "網美", "flower": "緋寒櫻", "fee": "門票$150", "desc": "三民里大窩部落，精緻日式造景 (需預約)。"},
    {"name": "詩朗櫻花坡", "region": "前山", "month": [1, 2], "type": "賞花", "flower": "八重櫻/昭和櫻", "fee": "免門票", "desc": "澤仁里詩朗部落，整片山坡粉紅花海。"},
    {"name": "詩朗部落祕境", "region": "前山", "month": [1, 2], "type": "健行", "flower": "枝垂櫻", "fee": "免門票", "desc": "澤仁里詩朗部落深處，在地人才知道的幽靜步道。"},
    {"name": "中巴陵櫻木花道", "region": "後山", "month": [2], "type": "賞花", "flower": "昭和櫻", "fee": "免門票", "desc": "華陵里中巴陵，免費粉紅隧道必拍。"},
    {"name": "青鬆園 (輕鬆園)", "region": "後山", "month": [2, 3], "type": "賞花", "flower": "墨染櫻/富士櫻", "fee": "門票$100", "desc": "華陵里上巴陵比該路段，賞花新秘境。"},
    {"name": "恩愛農場", "region": "後山", "month": [2, 3], "type": "賞花", "flower": "千島/富士櫻", "fee": "門票$100", "desc": "華陵里上巴陵中心路頂端，全台最知名爆炸花海。"},

    # --- 前山完整收錄 ---
    {"name": "角板山行館", "region": "前山", "month": [1, 2], "flower": "梅花/山櫻", "type": "賞花", "fee": "免門票", "desc": "北橫賞花起點，戰備隧道。"},
    {"name": "東眼山櫻花大道", "region": "前山", "month": [1, 2], "flower": "山櫻花", "type": "健行", "fee": "免門票", "desc": "林道兩旁紅色隧道。"},
    {"name": "羅馬公路", "region": "前山", "month": [1, 2], "flower": "山櫻花", "type": "兜風", "fee": "免門票", "desc": "最美兜風路線 (118縣道)。"},
    {"name": "成福道路", "region": "前山", "month": [1, 2], "flower": "山櫻花", "type": "兜風", "fee": "免門票", "desc": "東眼山支線 (桃119線) 秘境。"},
    {"name": "悠然秘境小屋", "region": "前山", "month": [2, 3], "flower": "吉野櫻", "type": "賞花", "fee": "門票$50", "desc": "三民隱藏版私人園區，花況極佳。"},
    {"name": "丸山咖啡", "region": "前山", "month": [2], "flower": "景觀櫻花", "type": "美食", "fee": "低消", "desc": "海拔600m景觀餐廳。"},
    {"name": "小烏來風景區", "region": "前山", "month": [1, 2], "flower": "山櫻花", "type": "景觀", "fee": "門票$50", "desc": "天空步道與瀑布。"},
    {"name": "新溪口吊橋", "region": "前山", "month": [1, 2, 3], "flower": "景觀", "type": "景觀", "fee": "門票$50", "desc": "全台最長懸索橋。"},

    # --- 部落深處完整收錄 ---
    {"name": "爺亨梯田", "region": "部落", "month": [1, 2, 3], "flower": "山櫻/桃花", "type": "景觀", "fee": "免門票", "desc": "梯田地景配粉色花海。"},
    {"name": "光華櫻花故事林道", "region": "部落", "month": [2, 3], "flower": "昭和櫻", "type": "秘境", "fee": "免門票", "desc": "光華國小旁浪漫林道。"},
    {"name": "比亞外部落", "region": "部落", "month": [1, 2], "flower": "昭和櫻", "type": "生態", "fee": "免門票", "desc": "藍腹鷴的故鄉。"},
    ...
    {"name": "上高義古路", "region": "部落", "month": [1, 2], "flower": "山櫻花", "type": "健行", "fee": "免門票", "desc": "北橫旁古道，幽靜自然。"},
    {"name": "雪霧鬧部落", "region": "部落", "month": [2, 3], "flower": "桃花/櫻花", "type": "秘境", "fee": "免門票", "desc": "雲端上的部落。"},

    # --- 後山完整收錄 ---
    {"name": "拉拉山遊客中心", "region": "後山", "month": [2, 3], "flower": "千島櫻", "type": "賞花", "fee": "免門票", "desc": "停車場就是絕美景點。"},
    {"name": "觀雲休憩農莊", "region": "後山", "month": [2, 3], "flower": "昭和櫻", "type": "賞花", "fee": "免門票", "desc": "恩愛農場旁免門票秘境。"},
    {"name": "光明農場", "region": "後山", "month": [3], "flower": "霧社櫻", "type": "美食", "fee": "需用餐", "desc": "稀有白櫻配馬告雞。"},
    {"name": "拉拉山巨木區", "region": "後山", "month": [1, 2, 3, 4], "flower": "神木", "type": "健行", "fee": "門票$100", "desc": "千年紅檜群深呼吸。"},
    {"name": "俠雲山莊", "region": "後山", "month": [2], "flower": "昭和櫻", "type": "賞花", "fee": "免門票", "desc": "梯田式櫻花林。"},
    {"name": "楓墅農莊", "region": "後山", "month": [2], "flower": "昭和櫻", "type": "秘境", "fee": "清潔費", "desc": "中心路小型秘境。"},
    {"name": "嶺鎮農場", "region": "後山", "month": [2, 3], "flower": "各類櫻花", "type": "景觀", "fee": "需消費", "desc": "俯瞰山谷視野極佳。"},
    ...
    {"name": "中心路沿線", "region": "後山", "month": [2, 3], "flower": "富士櫻", "type": "兜風", "fee": "部分收費", "desc": "前往恩愛農場路邊。"},
...
def generate_dynamic_itinerary(travel_date, days_str, group):
    ...
    top_picks = ["角板山行館", "翠墨山莊 (翠墨庄園)", "詩朗櫻花坡", "恩愛農場"]
    ...
    # --- Day 2: 深入後山 ---
    if day_count >= 2:
        # Day 2 上午：優先挑選後山指定新景點 (青鬆園/中巴陵) 或 健行
        d2_priority = ["青鬆園 (輕鬆園)", "中巴陵櫻木花道", "拉拉山巨木區"]
